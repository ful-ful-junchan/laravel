  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          <li class="">
            <a href="{{ url('/bootstrap/home') }}">
              <i class="now-ui-icons design_app"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/icons') }}">
              <i class="now-ui-icons education_atom"></i>
              <p>Icons</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/map') }}">
              <i class="now-ui-icons location_map-big"></i>
              <p>Maps</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/notifications') }}">
              <i class="now-ui-icons ui-1_bell-53"></i>
              <p>Notifications</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/user') }}">
              <i class="now-ui-icons users_single-02"></i>
              <p>User Profile</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/tables') }}">
              <i class="now-ui-icons design_bullet-list-67"></i>
              <p>Table List</p>
            </a>
          </li>
          <li class="">
            <a href="{{ url('/bootstrap/typography') }}">
              <i class="now-ui-icons text_caps-small"></i>
              <p>Typography</p>
            </a>
          </li>
          <li class="active active-pro">
            <a href="{{ url('/bootstrap/upgrade') }}">
